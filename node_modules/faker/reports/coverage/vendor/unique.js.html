...
<html lang="en">
<head>
    <title>Code coverage report for vendor/unique.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">vendor</a> unique.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// the `unique` module
var unique = {};
&nbsp;
...
&nbsp;
  ...
  opts.maxTime = opts.maxTime || <span class="branch-1 cbranch-no" title="branch not covered" >3;</span>
  opts.maxRetries = opts.maxRetries || <span class="branch-1 cbranch-no" title="branch not covered" >50;</span>
  opts.exclude = opts.exclude || exclude;
  opts.compare = opts.compare || defaultCompare;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof opts.currentIterations !== 'number') {
<span class="cstat-no" title="statement not covered" >    opts.currentIterations = 0;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof opts.startTime === 'undefined') {
<span class="cstat-no" title="statement not covered" >    opts.startTime = new Date().getTime();</span>
  }
&nbsp;
  var startTime = opts.startTime;
&nbsp;
  // support single exclude argument as string
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof opts.exclude === 'string') {
<span class="cstat-no" title="statement not covered" >    opts.exclude = [opts.exclude];</span>
  }
&nbsp;
