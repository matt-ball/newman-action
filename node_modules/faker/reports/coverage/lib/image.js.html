...
<html lang="en">
<head>
    <title>Code coverage report for lib/image.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> image.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  self.imageUrl = function (width, height, category, randomize, https) {
      ...
      var protocol = 'http://';
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof https !== 'undefined' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >https === true)</span> {
<span class="cstat-no" title="statement not covered" >        protocol = 'https://';</span>
      }
