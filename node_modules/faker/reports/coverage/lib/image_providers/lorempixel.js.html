...
<html lang="en">
<head>
    <title>Code coverage report for lib/image_providers/lorempixel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/image_providers</a> lorempixel.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
   ...
   */
  self.image = <span class="fstat-no" title="function not covered" >fu</span>nction (width, height, randomize) {
    var categories = <span class="cstat-no" title="statement not covered" >["abstract", "animals", "business", "cats", "city", "food", "nightlife", "fashion", "people", "nature", "sports", "technics", "transport"];</span>
<span class="cstat-no" title="statement not covered" >    return self[faker.random.arrayElement(categories)](width, height, randomize);</span>
  };
  /**
   * avatar
   *
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (randomize) {
<span class="cstat-no" title="statement not covered" >        url += '?' + faker.random.number()</span>
      }
&nbsp;
      return url;
  };
