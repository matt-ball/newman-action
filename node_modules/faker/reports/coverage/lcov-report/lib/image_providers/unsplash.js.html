...
<html lang="en">
<head>
    <title>Code coverage report for lib/image_providers/unsplash.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/image_providers</a> unsplash.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
   ...
   */
  self.avatar = <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    return faker.internet.avatar();</span>
  };
  /**
   * imageUrl
   *
