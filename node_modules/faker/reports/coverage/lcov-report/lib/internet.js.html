...
<html lang="en">
<head>
    <title>Code coverage report for lib/internet.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> internet.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">95% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>114/120</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L429'></a><a href='#L429'>429</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-yes">696x</span>
<span class="cline-any cline-yes">2784x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">696x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">86x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2019x</span>
...
<span class="cline-any cline-yes">86x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1933x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1933x</span>
<span class="cline-any cline-yes">643x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1290x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">86x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var random_ua = require('../vendor/user-agent');
&nbsp;
/**
 *
...
&nbsp;
   ...
   */
   self.password = function (len, memorable, pattern, prefix) {
     len = len || 15;
     <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof memorable === "undefined") {
       memorable = false;
     }
     /*
     ...
     var _password = function (length, memorable, pattern, prefix) {
       var char, n;
       <span class="missing-if-branch" title="if path not taken" >I</span>if (length == null) {
<span class="cstat-no" title="statement not covered" >         length = 10;</span>
       }
       <span class="missing-if-branch" title="if path not taken" >I</span>if (memorable == null) {
<span class="cstat-no" title="statement not covered" >         memorable = true;</span>
       }
       if (pattern == null) {
         pattern = /\w/;
       }
       ...
       <span class="missing-if-branch" title="if path not taken" >I</span>if (memorable) {
<span class="cstat-no" title="statement not covered" >         if (prefix.match(consonant)) {</span>
<span class="cstat-no" title="statement not covered" >           pattern = vowel;</span>
         } else {
<span class="cstat-no" title="statement not covered" >           pattern = consonant;</span>
         }
       }
       n = faker.random.number(94) + 33;
       char = String.fromCharCode(n);
       <span class="missing-if-branch" title="if path not taken" >I</span>if (memorable) {
<span class="cstat-no" title="statement not covered" >         char = char.toLowerCase();</span>
       }
